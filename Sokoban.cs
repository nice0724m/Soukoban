...
{
    public TextAsset stageFile; // ステージ構造が記述されたテキストファイル元
    public TextAsset stageFile1; // ステージ構造が記述されたテキストファイル1
    public TextAsset stageFile2; // ステージ構造が記述されたテキストファイル2
    public TextAsset stageFile3; // ステージ構造が記述されたテキストファイル3
    public TextAsset stageFile4; // ステージ構造が記述されたテキストファイル4
